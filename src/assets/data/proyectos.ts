...
export const proyectos = [
  {
    ...
    imgProyecto: ClipFlow,
    logo: ClipFlowLogo,
    nombre: 'ClipFlow',
    tecnologias: ['API', 'React', 'Tailwind CSS', 'TanStack Query', 'TypeScript'],
    descripcion: 'Genera shorts verticales automáticamente a partir de videos horizontales con IA.',
    codigo: 'https://github.com/Blackpachamame/ClipFlow',
  },
  // {
  //   id: crypto.randomUUID(),
