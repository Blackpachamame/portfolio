...
export default function ButtonCV() {
    return (
        <a href="https://drive.google.com/file/d/1MzFljB7K9GBj4OonykdQDLcnTEvIdOM3/view?usp=sharing" target="_blank" className="inline-flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-3
