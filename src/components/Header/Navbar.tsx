...
function Navbar() {
    return (
        <div className="self-center flex items-center justify-center space-x-4 font-semibold order-last flex-basis-[100%] md:order-none relative z-10 text-sm sm:text-xl">
